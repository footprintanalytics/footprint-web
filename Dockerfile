...
#trino driver
COPY --from=registry-intl.us-east-1.aliyuncs.com/mexl/foot-print-frontend:metabase-v0-41-drivers-builder-preview /home/circleci/bin/starburst.metabase-driver-1.0.6.jar ./plugins/
