...
import getFGARoutes from "metabase/ab/utils/routes";
    ...
    >
      ...
      <Route path="/research">
        ...
        <Route
          path="token"
          component={props => (
            <LazyLoad.Research {...props} classify="token" />
          )}
        >
          <Route path=":menu/:subMenu" />
          <Route path=":menu/:subMenu/:value" />
        ...
        <Route
          path="defi"
          component={props => (
            <LazyLoad.Research {...props} classify="defi" />
          )}
        >
          <Route path=":menu/:subMenu" />
          <Route path=":menu/:subMenu/:value" />
      ...
      <Route path="/solution/blockchain">
        <IndexRoute component={LazyLoad.blockchain} />
      </Route>
      <Route path="/solution/games">
        <IndexRoute component={LazyLoad.games} />
      </Route>
      ...
      <Route
        title={t`Growth`}
        path="/fga/:businessType/project-List"
