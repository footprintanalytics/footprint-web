...
export const DashboardApi = {
  ...
  cardQuery: POST(
    `/api/${window.location.search.includes("v1") ? "v1/" : ""}dashboard/:dashboardId/dashcard/:dashcardId/card/:cardId/query`,
  ),
  cardQueryPivot: POST(
...
export const PublicApi = {
  ...
  dashboardCardQuery: GET(
    `/api/${window.location.search.includes("v1") ? "v1/" : ""}public/dashboard/:uuid/dashcard/:dashcardId/card/:cardId`,
  ),
