...
export const CollectionsApi = {
  ...
  getRoot: GET("/api/v1/collection/root"),
  update: PUT("/api/v1/collection/:id"),
...
export const MetabaseApi = {
  db_list: GET("/api/v1/database", res => res["data"]),
  ...
  db_get: GET("/api/v1/database/:dbId"),
  db_update: PUT("/api/database/:id"),
  db_delete: DELETE("/api/database/:dbId"),
  db_metadata: GET("/api/v1/database/:dbId/metadata"),
  db_schemas: GET("/api/v1/database/:dbId/schemas"),
  db_schema_tables: GET("/api/v1/database/:dbId/schema/:schemaName"),
  //db_tables:   GET("/api/database/:dbId/tables"),
  db_fields: GET("/api/v1/database/:dbId/fields"),
  db_idfields: GET("/api/v1/database/:dbId/idfields"),
  ...
  db_card_autocomplete_suggestions: GET(
    "/api/v1/database/:dbId/card_autocomplete_suggestions",
  ),
