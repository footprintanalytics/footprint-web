...
export function showCohortSuccessModal(
  ...
  return modalApi.success({
    ...
    onOk() {
      ...
      // router?.push({
      //   pathname: `/ab/public/dashboard/55b1eb29-b15e-458f-9241-1862a0d19d3b`,
...
export function getPeaHost() {
  return isProduction ? "https://growthly.footprint.network" : "https://growthly-dev.footprint.network";
}
