...
const Index = ({router, location, onChangeLocation}) => {
  ...
  const data = {
    "plaza": {
      "title": "plaza",
      "url": `https://preview.footprint.network/public/research/gamefi/game-rankings/top-games`
    },
    "community": {
      "title": "community",
      "url": `https://preview.footprint.network/public/dashboard/Airflow-Job-Status-(beta)-fp-db970e7b-e22d-4271-9a15-e97187dc1b6b`
    },
    "account": {
      "title": "account",
