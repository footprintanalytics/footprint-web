...
export default {
  ...
  NotFoundFallbackPage: loadable(() => import("metabase/containers/NotFoundFallbackPage")),
  ...
  /* Browse data */
  PulseEditApp: loadable(() => import("metabase/pulse/containers/PulseEditApp")),
  NewModelOptions: loadable(() => import("metabase/new_model/containers/NewModelOptions")),
  CreateDashboardModal: loadable(() => import("metabase/components/CreateDashboardModal")),
  UserCollectionList: loadable(() => import("metabase/containers/UserCollectionList")),
  CollectionPermissionsModal: loadable(() => import("metabase/admin/permissions/components/CollectionPermissionsModal/CollectionPermissionsModal")),
  ArchiveCollectionModal: loadable(() => import("metabase/components/ArchiveCollectionModal")),
  MoveCollectionModal: loadable(() => import("metabase/collections/containers/MoveCollectionModal")),
  CollectionCreate: loadable(() => import("metabase/collections/containers/CollectionCreate")),
  QueryBuilder: loadable(() => import("metabase/query_builder/containers/QueryBuilder")),
  TableBrowser: loadable(() => import("metabase/browse/containers/TableBrowser")),
  SchemaBrowser: loadable(() => import("metabase/browse/containers/SchemaBrowser")),
  DatabaseBrowser: loadable(() => import("metabase/browse/containers/DatabaseBrowser")),
  BrowseApp: loadable(() => import("metabase/browse/components/BrowseApp")),
  ...
  AutomaticDashboardApp: loadable(() => import("metabase/dashboard/containers/AutomaticDashboardApp")),
  ...
  ResetPasswordApp: loadable(() => import("metabase/auth/containers/ResetPasswordApp")),
  ActivityApp: loadable(() => import("metabase/home/containers/ActivityApp")),

  // Reference Databases
  DatabaseListContainer: loadable(() => import("metabase/reference/databases/DatabaseListContainer")),
  DatabaseDetailContainer: loadable(() => import("metabase/reference/databases/DatabaseDetailContainer")),
  TableListContainer: loadable(() => import("metabase/reference/databases/TableListContainer")),
  TableDetailContainer: loadable(() => import("metabase/reference/databases/TableDetailContainer")),
  TableQuestionsContainer: loadable(() => import("metabase/reference/databases/TableQuestionsContainer")),
  FieldListContainer: loadable(() => import("metabase/reference/databases/FieldListContainer")),
  FieldDetailContainer: loadable(() => import("metabase/reference/databases/FieldDetailContainer")),

  HomePage: loadable(() => import("metabase/home/homepage/containers/HomePage")),
  CollectionLanding: loadable(() => import("metabase/collections/components/CollectionLanding")),


  // Reference Segments
  SegmentListContainer: loadable(() => import("metabase/reference/segments/SegmentListContainer")),
  SegmentDetailContainer: loadable(() => import("metabase/reference/segments/SegmentDetailContainer")),
  SegmentQuestionsContainer: loadable(() => import("metabase/reference/segments/SegmentQuestionsContainer")),
  SegmentRevisionsContainer: loadable(() => import("metabase/reference/segments/SegmentRevisionsContainer")),
  SegmentFieldListContainer: loadable(() => import("metabase/reference/segments/SegmentFieldListContainer")),
  SegmentFieldDetailContainer: loadable(() => import("metabase/reference/segments/SegmentFieldDetailContainer")),


  // Reference Metrics
  MetricListContainer: loadable(() => import("metabase/reference/metrics/MetricListContainer")),
  MetricDetailContainer: loadable(() => import("metabase/reference/metrics/MetricDetailContainer")),
  MetricQuestionsContainer: loadable(() => import("metabase/reference/metrics/MetricQuestionsContainer")),
  MetricRevisionsContainer: loadable(() => import("metabase/reference/metrics/MetricRevisionsContainer")),

  // Tools
  Tools: loadable(() => import("metabase/admin/tools/containers/Tools")),
  RedirectToAllowedSettings: loadable(() => import("metabase/admin/settings/containers/RedirectToAllowedSettings")),
  ...
  Logs: loadable(() => import("metabase/admin/tasks/containers/Logs")),
  Help: loadable(() => import("metabase/admin/tasks/containers/Help")),
  ModelCacheRefreshJobs: loadable(() => import("metabase/admin/tasks/containers/ModelCacheRefreshJobs/ModelCacheRefreshJobs")),
  ModelCacheRefreshJobModal: loadable(() => import("metabase/admin/tasks/containers/ModelCacheRefreshJobs/ModelCacheRefreshJobModal")),
  ...
  // Settings
  SettingsEditorApp: loadable(() => import("metabase/admin/settings/containers/SettingsEditorApp")),
  PremiumEmbeddingLicensePage: loadable(() => import("metabase/admin/settings/containers/PremiumEmbeddingLicensePage")),
  ...
  // permissions/routes
  CollectionPermissionsPage: loadable(() => import("metabase/admin/permissions/pages/CollectionPermissionsPage/CollectionPermissionsPage")),
  DatabasesPermissionsPage: loadable(() => import("metabase/admin/permissions/pages/DatabasePermissionsPage/DatabasesPermissionsPage")),
  GroupsPermissionsPage: loadable(() => import("metabase/admin/permissions/pages/GroupDataPermissionsPage/GroupsPermissionsPage")),
  DataPermissionsPage: loadable(() => import("metabase/admin/permissions/pages/DataPermissionsPage")),

  //notifications/routes
  NotificationsApp: loadable(() => import("metabase/account/notifications/containers/NotificationsApp")),
  HelpModal: loadable(() => import("metabase/account/notifications/components/HelpModal")),
  ArchiveAlertModal: loadable(() => import("metabase/account/notifications/containers/ArchiveAlertModal")),
  ArchivePulseModal: loadable(() => import("metabase/account/notifications/containers/ArchivePulseModal")),
  UnsubscribeAlertModal: loadable(() => import("metabase/account/notifications/containers/UnsubscribeAlertModal")),
  UnsubscribePulseModal: loadable(() => import("metabase/account/notifications/containers/UnsubscribePulseModal")),

  // timelines/routes
  DeleteEventModal: loadable(() => import("metabase/timelines/collections/containers/DeleteEventModal")),
  DeleteTimelineModal: loadable(() => import("metabase/timelines/collections/containers/DeleteTimelineModal")),
  EditEventModal: loadable(() => import("metabase/timelines/collections/containers/EditEventModal")),
  EditTimelineModal: loadable(() => import("metabase/timelines/collections/containers/EditTimelineModal")),
  MoveEventModal: loadable(() => import("metabase/timelines/collections/containers/MoveEventModal")),
  MoveTimelineModal: loadable(() => import("metabase/timelines/collections/containers/MoveTimelineModal")),
  NewEventModal: loadable(() => import("metabase/timelines/collections/containers/NewEventModal")),
  NewEventWithTimelineModal: loadable(() => import("metabase/timelines/collections/containers/NewEventWithTimelineModal")),
  NewTimelineModal: loadable(() => import("metabase/timelines/collections/containers/NewTimelineModal")),
  TimelineArchiveModal: loadable(() => import("metabase/timelines/collections/containers/TimelineArchiveModal")),
  TimelineDetailsModal: loadable(() => import("metabase/timelines/collections/containers/TimelineDetailsModal")),
  TimelineIndexModal: loadable(() => import("metabase/timelines/collections/containers/TimelineIndexModal")),
  TimelineListArchiveModal: loadable(() => import("metabase/timelines/collections/containers/TimelineListArchiveModal")),


  // audit_app/routes
  UnsubscribeUserModal: loadable(() => import("metabase-enterprise/audit_app/containers/UnsubscribeUserModal/UnsubscribeUserModal")),
  AuditApp: loadable(() => import("metabase-enterprise/audit_app/containers/AuditApp")),
  AuditOverview: loadable(() => import("metabase-enterprise/audit_app/pages/AuditOverview")),
  AuditDatabases: loadable(() => import("metabase-enterprise/audit_app/pages/AuditDatabases")),
  AuditDatabaseDetail: loadable(() => import("metabase-enterprise/audit_app/pages/AuditDatabaseDetail")),
  AuditSchemas: loadable(() => import("metabase-enterprise/audit_app/pages/AuditSchemas")),
  AuditSchemaDetail: loadable(() => import("metabase-enterprise/audit_app/pages/AuditSchemaDetail")),
  AuditTables: loadable(() => import("metabase-enterprise/audit_app/pages/AuditTables")),
  AuditTableDetail: loadable(() => import("metabase-enterprise/audit_app/pages/AuditTableDetail")),
  AuditQuestions: loadable(() => import("metabase-enterprise/audit_app/pages/AuditQuestions")),
  AuditQuestionDetail: loadable(() => import("metabase-enterprise/audit_app/pages/AuditQuestionDetail")),
  AuditDashboards: loadable(() => import("metabase-enterprise/audit_app/pages/AuditDashboards")),
  AuditDashboardDetail: loadable(() => import("metabase-enterprise/audit_app/pages/AuditDashboardDetail")),
  AuditQueryDetail: loadable(() => import("metabase-enterprise/audit_app/pages/AuditQueryDetail")),
  AuditUsers: loadable(() => import("metabase-enterprise/audit_app/pages/AuditUsers")),
  AuditUserDetail: loadable(() => import("metabase-enterprise/audit_app/pages/AuditUserDetail")),
  AuditDownloads: loadable(() => import("metabase-enterprise/audit_app/pages/AuditDownloads")),
  AuditSubscriptions: loadable(() => import("metabase-enterprise/audit_app/pages/AuditSubscriptions")),
}
