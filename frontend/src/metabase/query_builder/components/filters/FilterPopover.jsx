...
export default class ViewFilterPopover extends Component {
  ...
  UNSAFE_componentWillMount() {
    ...
    const { getNewGuideInfo, setNewGuideInfo } = this.props;
    const newGuideShowFilterField =
      // eslint-disable-next-line react/prop-types
      getNewGuideInfo && getNewGuideInfo["filterField"];
    if (newGuideShowFilterField) {
      setTimeout(() => {
        newGuideHighlight({
          key: "filterField",
          getNewGuideInfo,
  ...
  handleFilterChange = (newFilter: ?Filter) => {
    ...
    const { getNewGuideInfo, setNewGuideInfo } = this.props;
    closeNewGuide({ key: "filterFieldValue" });
    const newGuideShowFilterFieldValueConfirm =
      // eslint-disable-next-line react/prop-types
      getNewGuideInfo && getNewGuideInfo["filterFieldValueConfirm"];
    if (newGuideShowFilterFieldValueConfirm) {
      newGuideHighlight({
        key: "filterFieldValueConfirm",
        getNewGuideInfo,
        setNewGuideInfo,
      });
    }
