  ...
  render() {
    ...
    return (
      <SidebarContent
        ...
        className={cx(className, "spread", "summarizeSidebar")}
      >
        <div className="px3">
...
const SummarizeAggregation = ({ className, aggregation, index, query }) => {
  return (
    <div className={cx(className, "flex align-stretch")}>
      <PopoverWithTrigger
        triggerClasses="flex-full max-w-100-percent text-wrap"
        triggerElement={
    ...
    <PopoverWithTrigger
      ...
      triggerElement={
        <Flex
          ...
          px2
          mt2
          className="flex-full align-center rounded bg-light bg-medium-hover text-brand text-bold transition-all"
        >
