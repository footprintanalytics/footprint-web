...
import SvgEmpty from "metabase/components/icons/SvgEmpty";
...
const CollectionEmptyState = ({
  ...
  return (
    <EmptyState
      ...
      message={t`Use collections to organize and group dashboards and queries for your team or yourself`}
      className="text-medium"
      illustrationElement={<SvgEmpty />}
      ...
      link={
        <Link
          ...
          mt={2}
          to={Urls.newCollection(params && params.collectionId)}
