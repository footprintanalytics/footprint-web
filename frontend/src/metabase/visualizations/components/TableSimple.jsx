...
import { formatTableTitle, formatValue } from "metabase/lib/formatting";
import {
      ...
      <div className={cx(this.props.className, "relative flex flex-column")}>
        <div className="flex-full relative">
          ...
          >
            ...
            >
              <thead ref={this.headerRef} style={{ background: "#F8F8FC" }}>
                <tr>
                  {cols.map((col, colIndex) => (
                      ...
                      className={cx(
                        "TableInteractive-headerCellData cellData text-brand-hover text-medium",
                        {
                          "TableInteractive-headerCellData--sorted":
                            sortColumn === colIndex,
                          "text-right": isTranspose
                            ? false
                            : isColumnRightAligned(col),
                        },
                      )}
                    ...
                    >
                      <div className="relative">
                        ...
                        /> */}
                        <Ellipsified
                          className={cx({ "table-simple-title": !isTranspose })}
                        >
                          {formatTableTitle(getColumnTitle(colIndex))}
                          <Icon
                            name={sortDescending ? "chevrondown" : "chevronup"}
                            width={8}
                            height={8}
                    ...
                    {rows[rowIndex].map((value, columnIndex) => {
                      ...
                      return (
                        <td
                          ...
                          className={cx(
                            "text-dark fullscreen-normal-text fullscreen-night-text",
                            {
                              "text-right": isTranspose
                                ? true
                                : isColumnRightAligned(column),
                              "border-bottom": !isTranspose,
