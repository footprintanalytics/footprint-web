...
const DataApiButtons = ({ user, setLoginModalShow, onChangeLocation, blandButtonText = "Try for free", showGetApiKeyHelp = false }) => {
  return (
    <div className="data-api__buttons">
      ...
      >
        ...
        {showGetApiKeyHelp && (<Link to="https://docs.footprint.network/guides/api/api" target="_blank" className="text-underline text-underline-hover mt1">How to get API key?</Link>)}
      </div>
